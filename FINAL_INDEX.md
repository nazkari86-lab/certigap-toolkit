...
- [Proof-carrying typed DSL](certigap/dsl.py)
- [Independent DSL verifier](certigap/dsl_verifier.py)
- [DSL compiler CLI](certigap/dsl_compiler.py)
...
- [download_all_datasets.py](download_all_datasets.py)
...
- [external_dataset_inventory.md](results/external_dataset_inventory.md)
- [external_dataset_inventory.json](results/external_dataset_inventory.json)
...
- [Proof-carrying DSL validation](results/dsl_validation.md)
- [Verified DSL certificate example](results/dsl_certificate_example.json)
...
- [Proof-carrying DSL contract and boundary](docs/PROOF_CARRYING_DSL.md)
